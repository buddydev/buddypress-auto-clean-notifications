...
/**
 * Auto Loader for BP_Skeleton.
 *
 * After registering this autoload function with SPL, the following line
 * would cause the function to attempt to load the BP_Skeleton\Bar\Baz\Qux class
 * from /path/to/wp-content/plugins/bp-skeleton/src/bar/baz/class-qux.php:
 *
 *      new BP_Skeleton\Baz_Xyz\Qux;
...
class Autoloader {
	...
	/**
	 * Namespace root. eg. BP_Skeleton\\(escaped slashes);
	 *
	 * @var string
	 */
